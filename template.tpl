...

{
  ...
  "brand": {
    "id": "github.com_webminds-inc",
    "displayName": "webminds-inc",
...
if (savedSettings !== 'undefined' && savedSettings !== '') {
  ...
  const url = 'https://cdn.jsdelivr.net/gh/webminds-inc/consent/dist/consent.v2.min.js';
...
- name: Default Settings Sent
  code: |-
    const mockData = {
      // Mocked field values
      brandName: 'WebMinds',
      consentEventName: '__wmConsentPrefUpdated',
